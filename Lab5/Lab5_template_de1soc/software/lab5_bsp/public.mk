...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001200
SOPC_SYSID_FLAG += --sidp=0x8001200
ELF_PATCH_FLAG  += --sidp 0x8001200

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1584998784
SOPC_SYSID_FLAG += --timestamp=1584998784
ELF_PATCH_FLAG  += --timestamp 1584998784
