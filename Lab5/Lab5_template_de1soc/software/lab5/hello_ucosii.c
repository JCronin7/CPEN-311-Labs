...
void init_background() { // INIT BACKGROUND
	...
	//init lines
	vid_draw_line(652, 197/*234*/, 800, 197/*234*/, 4, WHITE_24, SW_Frame);
...
if (event == 1) {	//down event
	...
	if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 252
		...
		select_modulation(3);
	} else if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 215 // <- bonus code
			&& y_mouse <= (215 + 35)) {
...
//Init video
init_lfsr_interrupt();
init_color_change_interrupt();	// added for bonus
